...
public class MydebugRenderer {
	...
	protected void renderBody (Body body) {
		com.badlogic.gdx.physics.box2d.Transform transform = body.getTransform();
	...
	private void drawAABB (Fixture fixture, com.badlogic.gdx.physics.box2d.Transform transform) {
	...
	private void drawShape (Fixture fixture, com.badlogic.gdx.physics.box2d.Transform transform, Color color) {
		if (fixture.getType() == Type.Circle) {
			CircleShape circle = (CircleShape)fixture.getShape();
			t.set(circle.getPosition());
			transform.mul(t);
			drawSolidCircle(t, circle.getRadius(), axis.set(transform.vals[com.badlogic.gdx.physics.box2d.Transform.COS], transform.vals[com.badlogic.gdx.physics.box2d.Transform.SIN]), color);
			return;
		}
	...
	private void drawJoint (Joint joint) {
		...
		com.badlogic.gdx.physics.box2d.Transform xf1 = bodyA.getTransform();
		com.badlogic.gdx.physics.box2d.Transform xf2 = bodyB.getTransform();
	...
	public static void setAxis (Vector2 axis) {
		Box2DDebugRenderer.setAxis(axis);
	}
